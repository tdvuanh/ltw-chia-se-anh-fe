...
export const transformPhoto = (apiPhoto: any): Photo => {
  ...
  return {
    ...
    views: apiPhoto.views_count !== undefined ? apiPhoto.views_count : (apiPhoto.views || 0),
    views_count: apiPhoto.views_count !== undefined ? apiPhoto.views_count : (apiPhoto.views || 0),
    tags,
